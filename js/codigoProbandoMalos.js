...
function makeNewPosition(){
  ...
  setInterval(detectarColisionMalos,5);
  function detectarColisionMalos(){
    var bColision5 = null;
    var bColision6 = null;
    var bColision7 = null;
    var bColision8 = null;
    var colisionPersonajes = null;
  ...
  function llamadaAMalos(){
    for (var i = 1 ; i <= nivel ; i++) {
      ...
      $(fondo).append("<div id='"+i+"'><img id='maloIMG'src='img/malo.gif'></div>");
      $("#"+i).css({
                    "left": ancho+"px",
                    "top": alto +"px",
                    "position": "relative",
